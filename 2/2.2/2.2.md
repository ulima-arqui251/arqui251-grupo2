...
| **Disponibilidad**    | Falla del servicio SMTP                        | Proveedor de correo        | Módulo de envío de emails | Horario pico       | Encolar y reintentar el envío hasta 3 veces                                   | ≥ 99.5 % de correos enviados en ≤ 5 min                     |
| **Rendimiento**       | 500 usuarios inician sesión al mismo tiempo     | Usuarios concurrentes      | Endpoint `/login`         | Pico de mañana     | Procesar autenticaciones concurrentes sin degradación                         | Tiempo ≤ 300 ms (95 percentil)                              |
| **Mantenibilidad**    | Actualización de la lógica de 2FA              | Equipo de desarrollo       | Componente 2FA            | Producción         | Desplegar actualización sin interrumpir servicio                              | < 1 min de downtime y 99 % de sesiones mantienen conexión    |
...
| Atributo de Calidad | Estímulo                                        | Fuente del Estímulo     | Artefacto              | Entorno            | Respuesta                                                      | Medida de Respuesta                             |
|---------------------|-------------------------------------------------|-------------------------|------------------------|--------------------|----------------------------------------------------------------|-------------------------------------------------|
| **Escalabilidad**   | 1 000 estudiantes acceden a lecciones simultáneas | Usuarios concurrentes   | Servicio de contenido   | Evento global      | Balancear carga y cachear rutas de estudio                     | Entrega sin errores, latencia ≤ 500 ms          |
| **Fiabilidad**      | Pérdida de conexión durante una lección         | Usuario con red inestable | Módulo de lecciones    | Conexión inestable | Guardar progreso local y sincronizar al reconectarse           | ≤ 5 % de pérdida de avance                      |
